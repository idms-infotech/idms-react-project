const Model = require("../materialRevalidationModel");
 const MaterialRevalidationRepository = {
    createDoc: async obj => {
    ...
    filteredMaterialRevalidationList: async pipeline => {
        return await Model.aggregate(pipeline);
    }
};
module.exports = MaterialRevalidationRepository
