const Model = require("../../BCProdHouseModel/BCInkMixingModel");
const BCInkMixingRepository = {
    createDoc: async obj => {
    ...
    filteredBCInkMixingList: async pipeline => {
        return await Model.aggregate(pipeline);
    }
};
module.exports = BCInkMixingRepository;
