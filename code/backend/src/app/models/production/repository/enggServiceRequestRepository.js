const Model = require("../enggServiceRequestModel");
const EnggServiceRequestRepository = {
    createDoc: async obj => {
    ...
    filteredEnggServiceRequestList: async pipeline => {
        return await Model.aggregate(pipeline);
    }
};
module.exports = EnggServiceRequestRepository;
