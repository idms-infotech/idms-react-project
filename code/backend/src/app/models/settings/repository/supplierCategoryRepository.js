const Model = require("../supplierCategoryModel");
const SupplierCategoryRepository = {
    createDoc: async obj => {
    ...
    filteredSupplierCategoryList: async pipeline => {
        return await Model.aggregate(pipeline);
    }
};
module.exports = SupplierCategoryRepository;
