const Model = require("../deliveryChallanLocModel");
 const DeliveryChallanLocRepository = {
    createDoc: async obj => {
    ...
    filteredDeliveryChallanLocList: async pipeline => {
        return await Model.aggregate(pipeline);
    }
};
module.exports = DeliveryChallanLocRepository
