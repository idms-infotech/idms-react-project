const Model = require("../materialFlowZoneModel");
 const MaterialFlowZoneRepository = {
    createDoc: async obj => {
    ...
    filteredMaterialFlowZoneList: async pipeline => {
        return await Model.aggregate(pipeline);
    }
};
module.exports = MaterialFlowZoneRepository
