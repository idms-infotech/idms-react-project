const Model = require("../prospectSupplierModel");
 const ProspectSupplierRepository = {
    createDoc: async obj => {
    ...
    filteredProspectSupplierList: async pipeline => {
        return await Model.aggregate(pipeline);
    }
};
module.exports = ProspectSupplierRepository
