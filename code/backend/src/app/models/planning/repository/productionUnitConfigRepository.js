const Model = require("../productionUnitConfigModel");
 const ProductionUnitConfigRepository = {
    createDoc: async obj => {
    ...
    filteredProductionUnitConfigList: async pipeline => {
        return await Model.aggregate(pipeline);
    }
};
module.exports = ProductionUnitConfigRepository
