const Model = require("../prodItemStdCostModel");
 const ProdItemStdCostRepository = {
    createDoc: async obj => {
    ...
    filteredProdItemStdCostList: async pipeline => {
        return await Model.aggregate(pipeline);
    }
};
module.exports = ProdItemStdCostRepository
