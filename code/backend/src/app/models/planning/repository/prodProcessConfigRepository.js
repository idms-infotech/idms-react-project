const Model = require("../prodProcessConfigModel");
 const ProdProcessConfigRepository = {
    createDoc: async obj => {
    ...
    filteredProdProcessConfigList: async pipeline => {
        return await Model.aggregate(pipeline);
    }
};
module.exports = ProdProcessConfigRepository
