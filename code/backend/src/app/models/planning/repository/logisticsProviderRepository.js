const Model = require("../logisticsProviderModel");
 const LogisticsProviderRepository = {
    createDoc: async obj => {
    ...
    filteredLogisticsProviderList: async pipeline => {
        return await Model.aggregate(pipeline);
    }
};
module.exports = LogisticsProviderRepository
