const Model = require("../BoMJP15Model");
 const BillOfMaterialJP15Repository = {
    createDoc: async obj => {
    ...
    filteredBillOfMaterialJP15List: async pipeline => {
        return await Model.aggregate(pipeline);
    }
};
module.exports = BillOfMaterialJP15Repository
