const Model = require("../../SKUAttributesModels/packingStandardModel");
const PackingStandardRepository = {
    createDoc: async obj => {
    ...
    filteredPackingStandardList: async pipeline => {
...
module.exports = PackingStandardRepository;
