const Model = require("../planningItemMasterModel");
 const PlanningItemMasterRepository = {
    createDoc: async obj => {
    ...
    filteredPlanningItemMasterList: async pipeline => {
        return await Model.aggregate(pipeline);
    }
};
module.exports = PlanningItemMasterRepository
