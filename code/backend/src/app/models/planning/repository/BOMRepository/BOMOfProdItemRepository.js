const Model = require("../../billOfMaterialModels/BOMOfProdItemModel");
const BOMOfProdItemRepository = {
    createDoc: async obj => {
    ...
    filteredBOMOfProdItemList: async pipeline => {
        return await Model.aggregate(pipeline);
    }
};
module.exports = BOMOfProdItemRepository;
