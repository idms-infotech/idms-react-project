...
const prodItemCategory = require("./prodItemCategory/routes");
...
const itemCategoryJP = require("./itemCategoryJP/routes");
const SKUCategoryJP = require("./SKUCategoryJP/routes");
const supplierCategory = require("./supplierCategory/routes");
const customerCategory = require("./customerCategory/routes");
const LSPCategory = require("./LSPCategory/routes");
const dynamicForms = require("./dynamicForms/routes");
const materialFlowZone = require("./materialFlowZone/routes");
const reportFormats = require("./reportFormats/routes");
const reasonForCN = require("./reasonForCN/routes");
const deliveryChallanLoc = require("./deliveryChallanLoc/routes");
const KITCategory = require("./KITCategory/routes");
...
router.use("/prodItemCategory", prodItemCategory);
...
router.use("/itemCategoryJP", itemCategoryJP);
router.use("/SKUCategoryJP", SKUCategoryJP);
router.use("/supplierCategory", supplierCategory);
router.use("/customerCategory", customerCategory);
router.use("/LSPCategory", LSPCategory);
router.use("/dynamicForms", dynamicForms);
router.use("/materialFlowZone", materialFlowZone);
router.use("/reportFormats", reportFormats);
router.use("/reasonForCN", reasonForCN);
router.use("/deliveryChallanLoc", deliveryChallanLoc);
router.use("/KITCategory", KITCategory);
